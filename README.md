...
3. Ключ Kilo можно пропустить: нейросеть работает и без него, на бесплатных моделях. С ключом отвечают платные — быстрее (как получить — ниже).
4. Скажите «Джарвис», дождитесь отклика и дайте команду: «открой телеграм», «громкость тридцать».

## Нейросеть: Kilo

Всё, чего нет во встроенных командах (разговор, вопросы, «удали вчерашний скриншот»), понимает нейросеть через шлюз [Kilo](https://kilo.ai). VPN не нужен.

- **Без ключа** — бесплатные модели (до 200 запросов в час). Джарвис перебирает их сам, начиная с лучших по нашему тесту: Nemotron 3 Ultra, Ling 3.0 Flash, Dots3-Note.
- **С ключом** первыми отвечают платные модели: Gemini 3.5 Flash-Lite, затем Gemini 3.5 Flash и DeepSeek V4 Flash. Они точнее, быстрее и не упираются в лимит бесплатных; выходит около четырёх центов за полсотни просьб. Когда деньги кончатся, Джарвис сам вернётся к бесплатным.

Как получить ключ:

1. Откройте <https://app.kilo.ai> и зарегистрируйтесь или войдите.
2. **Your Profile** (личный аккаунт, не организация) → внизу страницы скопируйте ключ. Он один на аккаунт, начинается с `eyJ`.
3. Вставьте его в установщике на шаге «Нейросеть Kilo» или позже: окно Джарвиса → **Настройки → Джарвис → Нейросеть Kilo** → «Сохранить».
4. Пополнить баланс — там же, на app.kilo.ai (Kilo берёт 5% комиссии за пополнение, цены моделей без наценки).
...
| Разговор, сложные просьбы, цепочки действий | — | Kilo: бесплатные модели без ключа, платные с ключом; нейросеть сама вызывает действия ПК |
...
- **Нейросеть** (`llm.rs`) — шлюз Kilo через OpenAI-совместимый API (подходит и любой другой такой провайдер). Сначала платные модели, если есть ключ (`[[llm.providers]] name = "kilo"`), потом бесплатные (`KILO_FREE_MODELS`); модель, ответившая «перегружена» или «лимит», пропускается, ключ без денег (402) отдыхает час.
