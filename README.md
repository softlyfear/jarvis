...
- **Без ключа** — бесплатные модели (до 200 запросов в час). Джарвис перебирает их сам, начиная с самых быстрых по нашему тесту: Ling 3.0 Flash, Nemotron 3 Ultra, Dots3-Note.
- **С ключом** первыми отвечают платные модели: Gemini 3.5 Flash-Lite, затем DeepSeek V4 Flash. Они быстрее и не упираются в лимит бесплатных; выходит около трёх центов за полсотни просьб. Когда деньги кончатся, Джарвис сам вернётся к бесплатным.
